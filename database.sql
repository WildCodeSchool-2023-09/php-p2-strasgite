-- Schema strasgite
CREATE SCHEMA IF NOT EXISTS `php_p2_strasgite` DEFAULT CHARACTER SET utf8 ;
USE `php_p2_strasgite` ;
...
INSERT INTO `options` (name, is_available, prix)
...
INSERT INTO `categories` (nb_personnes, taille, theme)
...
CREATE TABLE IF NOT EXISTS `chambre` (
    ...
    CONSTRAINT `id_option` FOREIGN KEY (`id_option`) REFERENCES `options` (`id_options`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `id_categorie` FOREIGN KEY (`id_categorie`) REFERENCES `categories` (`id_categories`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;

INSERT INTO `chambre` (name, is_available, id_categorie, prix, description)
VALUES
    ('Chambre Chalet', 1, 1, 90, 'Votre description ici...'),
    ('Chambre Pierre', 1, 1, 80, 'Votre description ici...'),
    ('Chambre Chic', 1, 1, 100, 'Votre description ici...'),
    ('Chambre Botanique', 1, 1, 80, 'Votre description ici...');
...
CREATE TABLE IF NOT EXISTS `image` (
    ...
    CONSTRAINT `id_chambre_img` FOREIGN KEY (`id_chambre_img`) REFERENCES `chambre` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
INSERT INTO `user` (`firstname`, `lastname`, `email`, `password`, `adresse`, `tel`, `profession`, `isadmin`)
VALUES ('yavuz', 'yavuz', 'yavuz@yavuz.com', '$2y$10$/RTidqukVvJGUsTvAZSrK.ovYHT5u6QEVusap7pCohiONW7wZZep2', 'yavuz', 123456789, 'Autres', 1);
...
CREATE TABLE IF NOT EXISTS `favoris` (
    ...
    CONSTRAINT `favori_id_chambre` FOREIGN KEY (`favori_id_chambre`) REFERENCES `chambre` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `favori_id_user` FOREIGN KEY (`favori_id_user`) REFERENCES `user` (`id_user`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `avis` (
    ...
    CONSTRAINT `avis_id_chambre` FOREIGN KEY (`avis_id_chambre`) REFERENCES `chambre` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `avis_id_user` FOREIGN KEY (`avis_id_user`) REFERENCES `user` (`id_user`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
